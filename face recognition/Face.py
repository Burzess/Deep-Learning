...
train_dataset = ImageTensorDataset("/deep learning/dataset/TRAINING")  # Pastikan path sesuai dengan dataset training
...
torch.save(model.state_dict(), "train_model.pth")  # Save the model's state dict

model.load_state_dict(torch.load("train_model.pth", map_location=device))
